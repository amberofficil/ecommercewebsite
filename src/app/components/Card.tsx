...
const FloatingImageContentBlock = () => {
  return(
    <section className='container mx-auto py-10 flex flex-col md:flex-row items-center'>
      ...
      {" "}
      <p className='text-white mb-4'>Experience the juiciest burgers in town, made with fresh ingredients and grilled to perfecttion.</p>
      ...
      <h3 className='text-2xl font-semibold mt-6 mb-2 text-center text-white '>
        ...
        <ul className='text-white'>
          <li> <strong>Cheesy BBQ Bacon Burger:</strong>
             A mouthwatering blend of cheddar cheese, crispy bacon, and BBQ.</li>
          <br />
          <li> <strong>Spicy Jalapeno Burger:</strong>
             A fiery delight topped with fresh Jalapenos and zesty chipotle mayo.</li>
          <br />
          <li> <strong>Mushroom Swiss Burger:</strong>
             Juicy beef patty melted Swiss cheese for a rich, savory taste.</li>
          <br />

          <li> <strong>Avocado Veggie Burger:</strong>
             A delicious plant-based option featuring a grilled veggie patty.</li>
          <br />
